            ...
            <div id="myCarousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <div class="row">
                            <div class="col-xs-4" id="bcarousel" style="border-style: solid; boder-width: medium; background-color: white;"><img src="<?php echo $this->request->webroot; ?>images/large/dc-hall-t-shirt-royal-blue.jpg">
                               <h3>
                                  <?php echo $this->Html->link('$ 13.95', array('controller' => 'products', 'action' => 'view', 'slug' => $products[8]['Product']['slug'])); ?>
                               </h3>
                            </div>
                            <div class="col-xs-4" style="border-style: solid; boder-width: medium; background-color: white;"><img src="<?php echo $this->request->webroot; ?>images/large/dc-iikka-t-shirt-black.jpg">
                               <h3>
                                 <?php echo $this->Html->link('$ 9.95', array('controller' => 'products', 'action' => 'view', 'slug' => $products[9]['Product']['slug'])); ?>
                               </h3>
                            </div>
                            <div class="col-xs-4" style="border-style: solid; boder-width: medium; background-color: white;"><img src="<?php echo $this->request->webroot; ?>images/large/dc-shocked-t-shirt-celtic.jpg">
                               <h3>
                                 <?php echo $this->Html->link('$ 14.95', array('controller' => 'products', 'action' => 'view', 'slug' => $products[12]['Product']['slug'])); ?>
                               </h3>
                            </div>
                        </div>
                        <!--/row-->
